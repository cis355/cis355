<?php
	...
	$sql = "INSERT INTO customers2 (name) VALUES ('$name')"; 
	$q = $pdo->prepare($sql); 
	$q->execute(); 

	$sql = "INSERT INTO customers2 (name) VALUES (?)"; 
	$q = $pdo->prepare($sql); 
	...
	Zippydee'); INSERT INTO customers2 (name) VALUES ('William 
	') 
	*/ 
	...
	$con = mysqli_connect('localhost', 'wtbateso', '409856', 'wtbateso');
