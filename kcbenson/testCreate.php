...
class Customer { 
    ...
    function displayDeleteFredButton () { 
        ...
        echo "<a href='testCreate.php?deleteFreds=yes' class='btn btn-success'>Delete All Freds!!</a><br />"; 
     
    } 
     
    function displayLoginButton () { 
     
        echo "<a href='testCreate.php?empl_id=1' class='btn btn-success'>Set Empl ID to One</a><br />"; 
    ...
    echo ' <div class="container"> <div class="span10 offset1"> <div class="row"> <h3>Create a Customer</h3> </div><form class="form-horizontal" action="testCreate.php" method="post">  
