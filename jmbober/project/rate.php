...
*
* description : Displays a form that allows the user to rate a song, 
                then adds the rating information to songRatings table
*
* Structure: PHP:
              starts session
             ...
             HTML: 
              ...
              Body -- create form
*
precondition : database connection is valid, songRatings table exists with proper fields,
               user is logged in, and $_GET['id'] is set
postcondition: data is added to songRatings table, user is redirected to index
*
