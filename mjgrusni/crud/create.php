<?php 
	...
	#	3. User clicked create button (submit button) and all data is valid
	#		If that happens then PHP code inserts the record into the database according to database.php
