...
*
* description : this allows the user to update a business in the businees table 
*
* purpose: if the business info needs updated this file does that... 
*
* input : database.php
*
* processing : 
...
* 6. if valid update business information 
*
* output : outputs the html elements for the nav as well as the form for business info 
*
...
session_Start();
	...
	$dest = "Location: home.php?&errorMsg=updatingBusiness";
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$sql = "UPDATE business set businessName =? , businessDescription = ?, city = ?,state = ?,zip = ?,phone = ?,email = ? WHERE businessId = ?";
			$q = $pdo->prepare($sql);
			$q->execute(array($businessName,$description,$city,$state,$zip,$phone,$email,$businessId));
			Database::disconnect();
...
<head>
    ...
    <title>Gigs|Update Business</title>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
								...
								<h1>Update Business</h1>
										...
										<form action="updatebusiness.php?businessId=<?php echo $businessId;?>" method="post">
