...
class Dog extends Animal implements Eat{
	...
	function run() {
		echo $this->name . " goes sUPER quIck Faster than THE SPEED OF LIGHT <br />";
	}
	function eat() {
		echo $this->name . " eats gourmet fillet mignon <br />";
	}
}
...
class Elephant extends Animal implements Eat{
	...
	function run() {
		echo $this->name . " runs like boom...boom <br />";
	}
	function eat() {
...
abstract class Enemy {
	protected $name;
	abstract function powerLvl();
	abstract function equipment();
