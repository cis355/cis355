...
<?php 
	...
	# 1. User clicked create button on list screen (program1.php)
	...
	#         If that happens then PHP code inserts the record and redirect to list screen (program1.php)
    			...
    			<div class="span10 offset1">
	    			...
	    			<form class="form-horizontal" action="create.php" method="post">
					  ...
					  <div class="form-actions">
						  ...
						  <a class="btn btn-primary" href="program1.php">Back</a>
						</div>
