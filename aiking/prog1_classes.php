...
class Customer {
	...
	public function displayRecords () {
		...
		foreach ($pdo->query($sql) as $row) {
			...
			echo '&nbsp;';
			echo '<a class="btn btn-success" href="prog1_classes.php?update=yes&id='.$row['id'].'">Update</a>';
			echo '&nbsp;';
	...
	public function updateRecord ($id) {
		...
		echo '<form class="form-horizontal" action="prog1_classes?id="' . $data['id'] . 'method="post">';
