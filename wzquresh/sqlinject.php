...
if (isset($name2)) echo "name2 is set";
else echo "name2 is not set<br/><br/>";
echo '<br/><br/><a type="button" href="displayTable.php" class="btn btn-success">Display Table</a><br/><br/>';
