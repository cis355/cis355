...
class Customer {
  ...
  function displayCreateScreen(){
    echo "<a href='crud/create.php' class='btn btn-success'>Create</a><br/>";
  }
  
  function displayReadScreen(){
    echo "<a href='crud/read.php' class='btn btn-success'>Read</a><br/>";
  }
  
  function displayUpdateScreen(){
    echo "<a href='crud/update.php' class='btn btn-success'>Update</a><br/>";
  }
